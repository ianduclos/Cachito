...
function GameSummary({ view, analysis, history, connected, isHost, onReturnToLobby, onExit }: { view: PublicGameView; analysis?: MatchAnalysis; history: string[]; connected: boolean; isHost: boolean; onReturnToLobby: () => void; onExit: () => void }) {
