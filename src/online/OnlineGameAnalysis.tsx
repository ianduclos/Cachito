...
export function GameSummary({ view, analysis, history, connected, canReturnToLobby, onReturnToLobby, onExit }: { view: PublicGameView; analysis?: MatchAnalysis; history: string[]; connected: boolean; canReturnToLobby: boolean; onReturnToLobby: () => void; onExit: () => void }) {
