...
- **Bluff** — how often the player’s final challenged claim was unsupported at reveal. Only verified final bids count, which avoids mislabelling intermediate bids and table-dice rerolls.
...
- the exact versioned `analysis` delivered after game over.
